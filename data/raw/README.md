...
This folder contains unchanged local copies of the public PVD datasets used by the project. They are the published, anonymized release rather than original fab-raw sensor traces.
...
The CSV files are ignored by Git to keep the repository small and to make the official DOI the canonical download source. Place downloaded files in this directory before running the scripts.
